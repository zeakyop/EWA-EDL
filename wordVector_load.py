...
'''
    ...
    sio.savemat("mat/CBET" + str(k) +".mat", {'trainFeature': train_set, 'trainDistribution': train_label, 'trainNum': 46116,
                                'testFeature': test_set, 'testDistribution': test_label, 'testNum': 5124})
